...
public class Track extends Media {
    ...
    /**
     * These are alternative tracks that are the same thing. They might have different restrictions than the main track, for instance.
     */
    private List<Track> alternatives = new ArrayList<Track>();
    ...
    public boolean isAllowed(String country) {
        return !isRestricted(country, "premium");
    }
}
